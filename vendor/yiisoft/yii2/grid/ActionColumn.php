    ...
    protected function initDefaultButtons()
    {
        if (!isset($this->buttons['view'])) {
            $this->buttons['view'] = function ($url, $model, $key) {
                $options = array_merge([
                    'class' => Yii::t('yii', 'btn btn-success'),
                    'title' => Yii::t('yii', 'Lihat detail'),
                    'aria-label' => Yii::t('yii', 'View'),
                    'data-pjax' => '0',
                ], $this->buttonOptions);
                return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', 'shopcart/a/view/'.$key, $options);
            };
        }
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function ($url, $model, $key) {
                $options = array_merge([
                    'class' => Yii::t('yii', 'btn btn-danger'),
                ...
                return Html::a('<span class="glyphicon glyphicon-trash"></span>', 'shopcart/a/delete/'.$key, $options);
            };
        }
    }
