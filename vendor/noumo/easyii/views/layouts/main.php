...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title><?= Yii::t('easyii', 'Detolixir Admin Panel') ?> - <?= Html::encode($this->title) ?></title>
        ...
        <div class="wrapper">
            ...
            <div class="main">
                <div class="box sidebar">
                    <a href="<?= Url::to(['/admin']) ?>" class="menu-item <?= ($moduleName == 'admin' && $this->context->id == 'home') ? 'active' :'' ?>">
                        <i class="glyphicon glyphicon-home"></i>
                        <?= Yii::t('easyii', 'Home') ?>
                    </a>
                    <a href="<?= Url::to(['/admin/kurir']) ?>" class="menu-item <?= ($moduleName == 'kurir' && $this->context->id == 'kurir') ? 'active' :'' ?>">
